...
const OffcanvasCreate = () => {
  return (
    <div className='create-container'>
        <button className="button " type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight"><BiSolidVideoPlus /></button>
        ...
        style={{
            ...
            <div className="offcanvas-body" style={{padding:'5px 0px', marginTop:'6px'}}>
                <div className="upload-video d-flex justify-content-start align-items-center">
                    <p style={{margin:'2px', padding:'0px 10px'}}><RiVideoUploadLine  /></p>
                    <p style={{fontSize:'small', margin:'8px'}}>Upload video</p>
                </div>
                <div className="go-live d-flex justify-content-start align-items-center">
                    <p style={{margin:'2px', padding:'0px 10px'}}><BsSoundwave /></p>
                    <p style={{fontSize:'small', margin:'8px'}}>Go live</p>
                </div>
                <div className="create-post d-flex justify-content-start align-items-center">
